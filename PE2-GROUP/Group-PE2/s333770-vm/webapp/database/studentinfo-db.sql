...
CREATE DATABASE IF NOT EXISTS `studentinfo` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `studentinfo`;

-- --------------------------------------------------------

--
-- Tabellstruktur for tabell `postaltable`
--

DROP TABLE IF EXISTS `postaltable`;
CREATE TABLE `postaltable` (
  `postalNr` char(4) NOT NULL,
  `postalArea` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dataark for tabell `postaltable`
--

INSERT INTO `postaltable` (`postalNr`, `postalArea`) VALUES
('0001', 'OSLO'),
('0010', 'OSLO'),
('0015', 'OSLO'),
('0018', 'OSLO'),
...
INSERT INTO `students` (`studentID`, `firstName`, `lastName`, `email`, `address`, `postalNr`, `degree`) VALUES
-- Databaser
('s111111', 'Peter', 'Parker', 'peterp@oslomet.no', 'Storgata 08', '0155', 'Information Technology'),
('s222222', 'Andy', 'Yang', 'andyy@oslomet.no', 'Pilestredet 35', '0166', 'Software Engineering'),
('s333333', 'Monica', 'Bakke', 'monicab@oslomet.no', 'Bjerkeveien 33', '1350', 'Applied Computer Technology');

-- ---------------------------------------------------------

--
-- Tabellstruktur for tabell `Degree`
--
...
--
-- Indexes for table `postaltable`
--
ALTER TABLE `postaltable`
  ADD PRIMARY KEY (`postalNr`),
  ADD UNIQUE KEY `postalNr_UNIQUE` (`postalNr`);
...
ALTER TABLE `students`
  ...
  ADD UNIQUE KEY `student_ID_UNIQUE` (`studentID`),
  ADD KEY `fk_studentInformation_postaltable_idx` (`postalNr`);
...
ALTER TABLE `degree`
  ...
  ADD UNIQUE KEY `courseID_UNIQUE` (`degree`);
...
--
-- Begrensninger for tabell `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `fk_studentInformation_postaltable` FOREIGN KEY (`postalNr`) REFERENCES `postaltable` (`postalNr`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_degree`FOREIGN KEY (`degree`) REFERENCES `degree` (`degree`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
